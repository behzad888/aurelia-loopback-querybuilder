System.config({
  ...
  map: {
    ...
    "jQuery-QueryBuilder": "npm:jQuery-QueryBuilder@2.4.3",
    "jquery": "npm:jquery@3.2.1",
    "jquery-ts": "npm:jquery-ts@2.1.1",
    ...
    "npm:jQuery-QueryBuilder@2.4.3": {
      "bootstrap": "npm:bootstrap@3.3.7",
      "dot": "npm:dot@1.1.2",
      "jquery": "npm:jquery@3.2.1",
      "jquery-extendext": "npm:jquery-extendext@0.1.2",
      "moment": "npm:moment@2.18.1",
      "process": "github:jspm/nodelibs-process@0.1.2"
    },
    "npm:jquery-extendext@0.1.2": {
      "jquery": "npm:jquery@3.2.1"
    },
    "npm:jquery-ts@2.1.1": {
      "jquery": "npm:jquery@3.2.1"
